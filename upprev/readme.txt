...
= 3.3.21 - 2015-07-07 =
* **Improvement**: Replaced WP_http://iworks.pl/iw_plugin/upprev/ with plugins_url() thx to [tigr](http://wordpress.org/support/profile/tigr) [SSL compatibility](http://wordpress.org/support/topic/ssl-compatibility).
